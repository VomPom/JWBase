...
/**
 * Created by Julis on 2019/01/31 20:08
 * <p>
 * description:
 */
public class CBannerAdapter extends PagerAdapter {
    ...
    public CBannerAdapter(List<ImageView> images, ViewPager viewPager){
        this.images  = images;
    ...
    public class CBannerOnclickListener implements View.OnClickListener {
        @Override
        public void onClick(View v) {
            ToastUtils.showToast("11234");
        }
    }
