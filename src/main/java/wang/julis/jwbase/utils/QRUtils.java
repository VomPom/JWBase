...
public class QRUtils {
    public static Bitmap createQRImage(String content, int heightPix, int logoBm) {
        try {
            ...
            if (logoBm != 0) {
                bitmap = addLogo(bitmap, BitmapFactory.decodeResource(NaApplication.getApp().getResources(), logoBm));
            }
